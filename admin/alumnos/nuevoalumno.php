	...
	<?php include ('../../sidebar.php')?>
			...
			<div id="main">
				...
				<form action="guardar.php" method="POST" autocomplete="off" pattern="\S">
					...
					<p>Celular</p>
					<input type="text" name="celular" placeholder="Numero de Celular" maxlength="11" pattern="[0-9]{11}" required oninvalid="this.setCustomValidity('Codigo de pais y luego el numero')" oninput="this.setCustomValidity('')" >
					<br><br>
