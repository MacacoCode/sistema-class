		...
		<div id="main" >
				<div class="contenedor-tabla"> 
					...
					<table class="tabla" id="buscador">
                        ...
                        <?php 
                        $sql="SELECT materias.idmateria as idmateria, materias.nombre as materia, hora_materia.horainicio as inicio, hora_materia.horfinal as final, materias_alumnos.idgrupo as grupo, hora_materia.dia as dia
                        from materias_alumnos, hora_materia, materias
                        where materias_alumnos.idmateria=hora_materia.idmateria and materias_alumnos.idmateria=materias.idmateria and materias_alumnos.idgrupo=hora_materia.idgrupo and materias_alumnos.idalumno='$usuario';";
